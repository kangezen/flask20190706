...
class CCTVModel :
    ...
    def hook(self) -> object:
        ...
        #print(crime)
        #police = pd.pivot_table(crime, index = '관서명', aggfunc=np.sum) #pivot_table -> 가로, 세로 변환
        #print(police.columns)

    def create_cctv_pop(self) -> object:
        self.dr._context = './data/'
        self.dr._fname = 'CCTV_in_Seoul.csv'
        ...
        고령자비율 과 CCTV 상관계수 [[ 1.         -0.28078554]
                                    [-0.28078554  1.        ]] 
         외국인비율 과 CCTV 상관계수 [[ 1.         -0.13607433]
                                    [-0.13607433  1.        ]]
